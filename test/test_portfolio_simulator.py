...
def test_calculate_portfolio_prices(portfolios_csv_path, prices_csv_path, portfolio_prices_csv_path):
    simulator = PortfolioSimulator()
    simulator.load_portfolios(portfolios_csv_path)
...
def test_update_asset_price():
    ...
    calculated_prices = []
    simulator.update_asset_price(simulator.portfolios, "Asset1", 15.0, calculated_prices)
